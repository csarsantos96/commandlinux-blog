...
The website can run locally without environment variables, but reactions and post translation require the following values:
...
├── api/                  # Serverless API for post reactions
