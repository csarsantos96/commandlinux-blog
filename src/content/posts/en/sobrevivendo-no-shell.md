---
title: 'Surviving the Shell: From FHS to Diff, the Linux You Use Every Day'
description: >-
...
sourceHash: 374b54a678a6475b489b319a6672f521f223510aff64f3d45c1fa0808de2a27f
---
...
| `/home` | Users' personal directories. If your user is `devops`, it will be `/home/devops`. The `~` shortcut represents yours |
...
| `/dev` | Contains device files. This is also where the famous `/dev/null`, Linux's black hole, is located |
...
| `ls --color=auto` | Uses colors to differentiate file types, but only when the output is being displayed directly in the terminal |
...
- [LINUXtips — Linux for Cloud Native](https://linuxtips.io/linux-para-cloud-native/) — the course that originated my studies and these notes, within the PICK track.
